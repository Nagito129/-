/**
 * @file Wall_Sample.h
 * @brief Объявление класса Wall_Sample для работы с образцом стены
 */
...
#include <QCursor>
 ...
 /**
  * @brief Класс для работы с образцом стены
  */
class Wall_Sample : public QGraphicsItem
{
public:
    /**
     * @brief Конструктор класса Wall_Sample
    ...
    /**
     * @brief Конструктор класса Wall_Sample без параметров
     */
    Wall_Sample();
