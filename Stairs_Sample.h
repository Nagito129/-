/**
 * @file Stairs_Sample.h
 * @brief Объявление класса Stairs_Sample для работы с образцом лестницы
 */
...
#include <QCursor>
 ...
 /**
  * @brief Класс для работы с образцом лестницы
  */
class Stairs_Sample : public QGraphicsItem
{
public:
    /**
     * @brief Конструктор класса Stairs_Sample
